        ...
        <div className="flex min-h-screen">
          ...
          <aside className="w-64 bg-gray-800 text-white p-6 hidden md:block">
            ...
            <nav className="space-y-4">
              ...
              <a href="/dashboard/tasks" className="block p-2 hover:bg-gray-700 rounded">Tasks</a>
              <a href="/dashboard/projects" className="block p-2 hover:bg-gray-700 rounded">Projects</a>
            </nav>
          </aside>
